...
public class ELData implements java.io.Serializable {
    ...
    public ELData(String resurceId, String date, String leaveType, Date leaveStartDate, Date leaveEndDate,
	    Integer totalDays, String status, String satatusDescription) {
	this.resurceId = resurceId;
	this.date = date;
